...
const DISTRITOS = ["Ancón", "Ventanilla", "Puente Piedra", "Carabayllo", "Comas", "Santa Rosa"];
            ...
            <div className="opacity-0 scroll-animate" data-animation="animate-slide-right delay-200">
              {status === "success" ? (
                <div className="text-center py-16 bg-gray-50 border border-gray-100 rounded-sm">
                  ...
                  <button
                    onClick={() => { setStatus("idle"); setForm({ nombre: "", ruc_dni: "", tipo_concreto: "", volumen: "", ubicacion: "", tipo_vaciado: "bomba" }); }}
